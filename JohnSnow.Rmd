...
#rel
temp <- geom_raster(data = rel, aes_string(x = "x", y = "y", alpha = "OSMap"))
...
ggplot() +
  ...
  #scale_y_discrete()+
  #geom_point(data = deaths_f, aes(x = "x", y = "y"), colour = "black", size = 3) +
  #geom_point(data = deaths_f, aes(x = "x", y = "y"), colour = "skyblue1", size = 1.5) +  
...
#ggplot() +
#  geom_point(data = deaths_f, aes(x = "x", y = "y"), colour     = "black", size = 1) +  
#  scale_fill_identity()

#ggplot2::ggplot(deaths_f, environment = temp) 
```
